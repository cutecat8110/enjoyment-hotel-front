...
import type { NuxtI18nRoutingCustomProperties, ComposerCustomProperties } from 'F:/程式設計相關/TypeScript直播班/team/node_modules/@nuxtjs/i18n/dist/runtime/types.ts'
import type { Strategies, Directions, LocaleObject } from 'F:/程式設計相關/TypeScript直播班/team/node_modules/@nuxtjs/i18n/dist/types.d.ts'
