...
export const localeLoaders = {
  "en": [{ key: "../locales/en.json", load: () => import("../locales/en.json" /* webpackChunkName: "locale__Users_renee_Desktop_enjoyment_hotel_locales_en_json" */), cache: true }],
  "zh": [{ key: "../locales/zh.json", load: () => import("../locales/zh.json" /* webpackChunkName: "locale__Users_renee_Desktop_enjoyment_hotel_locales_zh_json" */), cache: true }]
}
