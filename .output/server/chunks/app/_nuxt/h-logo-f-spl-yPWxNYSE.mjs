...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-bg-f-wrapper bg-background flex-column min-h-screen d-flex" }, _attrs))} data-v-9b5b93a5>`);
  _push(ssrRenderComponent(_component_PageHeader, {
    class: "sticky-top",
    status: "logo"
  }, null, _parent));
  _push(`<main data-v-9b5b93a5>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/h-logo-f-spl.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const hLogoFSpl = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-9b5b93a5"]]);

export { hLogoFSpl as default };
//# sourceMappingURL=h-logo-f-spl-yPWxNYSE.mjs.map
