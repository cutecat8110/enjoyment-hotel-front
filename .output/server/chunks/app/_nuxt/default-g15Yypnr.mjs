...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "default-wrapper flex-column min-h-screen d-flex bg-primary-tint" }, _attrs))} data-v-7a01b03d>`);
  _push(ssrRenderComponent(_component_PageHeader, { class: "fixed-top" }, null, _parent));
  _push(`<main data-v-7a01b03d>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-7a01b03d"]]);

export { _default as default };
//# sourceMappingURL=default-g15Yypnr.mjs.map
